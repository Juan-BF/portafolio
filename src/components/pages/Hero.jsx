                        ...
                        <div className={styles.social}>
                            ...
                            <a href="https://www.linkedin.com/in/juan-vicente-bejarano-fernandez-062089239/" target="_blank" rel="noopener noreferrer" className={styles.Btn}>
                                <span className={`${styles.svgContainer} ${styles.svgContainerl}`}>
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 256 256" width="40px" height="100px">
                            ...
                            <a className={styles.btnBoox} href="https://drive.google.com/file/d/1-NQs2JPPeIH2b1fYKBLWQTnDvH1sOo7J/view?usp=drive_link" target="_blank" rel="noopener noreferrer" >
